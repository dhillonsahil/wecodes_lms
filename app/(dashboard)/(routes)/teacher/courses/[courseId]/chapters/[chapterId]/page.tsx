...
import ChapterForm from './_components/chapter-title';
...
const ChapterIdPage = async({params}:{params:{courseId:string,chapterId:string}}) => {
  ...
  return (
    ...
    {!chapter.isPublished && (
        <>
    <Banner label={'This chapter is not published'} />
        </>
    ) }
     {chapter.isPublished && (
        <>
    <Banner variant={'success'} label={'This chapter is published'} />
        </>
    ) }
    <div className='p-6'>
        <div className="flex items-center justify-between">
            <div className="w-full">
                ...
                <ArrowLeftIcon className='h-4 w-4 mr-2'/> Back to course setup
                </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
            <div className="space-y-4">
                <div>
                    ...
                    {/* Chapter Title Form */}
                    <ChapterForm initialData={chapter} courseId={params.courseId} chapterId={params.chapterId} />
